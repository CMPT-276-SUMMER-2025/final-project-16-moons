...
export default function Vertical1() {
    ...
    return(
        <div className={`flex flex-col items-center justify-center space-y-15 px-4 transition ${isVisible ? 'opacity-100 translate-y-0 delay-500' : 'opacity-0 translate-y-10'}`}>
